...
class MachineCom(object):
    ...
    def _changeState(self, newState):
        ...
        text = 'Changing monitoring state from "{}" to "{}"'.format( # 참고 
            oldState, self.getStateString()
        )
        self._log(text)
            ...
            try:
                ...
                try:
                    ...
                    if linenumber is not None:
                        ...
                        self._do_send(command, gcode=gcode) # 여기 
    ...
    def _do_send_with_checksum(self, command, linenumber): # 여기 같은데?
